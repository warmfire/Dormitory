...
<%
	...
	studentList = studentDao.queryStudentList(request.getParameter("sid"));
%>
</head>
...
<body>
	...
	<div id="index_list">
        ...
        <a href="stuindex.jsp?sid=<%= request.getParameter("sid")%>"><div id="index_list_in"><p align="center">我的信息</p></div></a>
